...
import com.panibrat.tree.QuadTree;
...
public class SolutionTest {
  ...
  public void intersect() {
    Node a = QuadTree.build(new int[][] {{1, 1}, {0, 0}});
    Node b =
        QuadTree.build(
            new int[][] {
              {1, 1, 0, 0},
    ...
    Node c = QuadTree.build(new int[][] {{1, 1}, {1, 0}});
    assertThat(new Solution().intersect(a, b)).isEqualToComparingFieldByFieldRecursively(c);
  }
}
